Shader "Unlit/Fill_Color"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "Normal"
            CGPROGRAM
            #pragma vertex Transform_NoTC
            #pragma fragment SolidFill
            // make fog work
            ...
            fixed4 SolidFill(v2f i) : SV_Target
            {
                return Premultiply(CxForm(i.color));
            }
            ENDCG
        }
        ...
        Pass
        {
            ...
            fixed4 SolidFill_L(v2f i) : SV_Target
            {
                return FromLinear(CxForm(i.color));
            }
            ENDCG
        }
        ...
        Pass
        {
            ...
            {
                return MaskPixel(i.uv,SolidFill(i.color));
            }
        ENDCG
        }
        ...
        Pass
        {
            ...
            fixed4 SolidFill_LM(v2f i) : SV_Target
            {
                return MaskPixel(i.uv,FromLinear(SolidFill(i.color)));
            }
        ENDCG
        }
    }
