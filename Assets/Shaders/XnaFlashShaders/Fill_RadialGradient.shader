Shader "Unlit/Fill_RadialGradient"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f Transform_ZO(appdata v)
            {
                ...
                {
                    v.uv.xy = TRANSFORM_TEX(v.uv.xy, _MainTex);
                }
        ...
        Pass
        {
            ...
            fixed4 RadialFill_L(v2f i) : SV_Target
            {
                return FromLinear(RadialFill(i));
            }
            ENDCG
        }
        ...
        Pass
        {
            ...
            fixed4 Radial_M(v2f i) : SV_Target
            {
                return MaskPixel(i.uv,RadialFill(i));
            }
        ENDCG
        }
        ...
        Pass
        {
            ...
            fixed4 RadialFill_LM(v2f i) : SV_Target
            {
                return MaskPixel(i.uv,FromLinear(RadialFill(i)));
            }
        ENDCG
        }
    }
